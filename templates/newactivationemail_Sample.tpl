...
<li>Recevoir des emails du club</li>
</ul>
<p>Utiliser l'espace privé, c'est aider nos éducateurs.</p>
<p>Ton compte vient d'être activé sur le site,</p>
<p>L'espace se trouve à l'adresse suivante : <a href="http://localhost/rookie/index.php?page=mon-compte">http://ping.agi-webconseil.fr/</a>
<h3>Tes identifiants</h3>
<p>Ton identifiant est celui-ci: {$nom_complet},<br /> ton <strong>mot de passe</strong> est le suivant : {$motdepasse}<br />
<p>Rappel : </p>
